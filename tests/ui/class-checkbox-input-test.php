...
use WP_Typography\UI\Checkbox_Input;
...
/**
 * WP_Typography\UI\Checkbox_Input unit test.
 *
 * @coversDefaultClass \WP_Typography\UI\Checkbox_Input
 * @usesDefaultClass \WP_Typography\UI\Checkbox_Input
 *
 * @uses ::__construct
 * @uses \WP_Typography\UI\Input::__construct
 * @uses \WP_Typography\UI\Control::__construct
 */
class Checkbox_Input_Test extends \WP_Typography\Tests\TestCase {
	 ...
	 * Test fixture.
	 *
	 * @var \WP_Typography\UI\Checkbox_Input
	 */
	protected $input;
	...
	protected function setUp() { // @codingStandardsIgnoreLine
		...
		$this->invokeMethod( $this->input, '__construct', [ $this->options, 'my_id', $args ], Checkbox_Input::class );
	}
	...
	public function test_constructor() {
		...
		$this->invokeMethod( $input, '__construct', [ $this->options, 'my_id', $args ], Checkbox_Input::class );
